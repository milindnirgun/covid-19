...
curl https://covidtracking.com/api/v1/us/daily.csv -o ./data/us_covid19_daily.csv
if [ $? -ne 0 ]; then
...
curl https://covidtracking.com/api/v1/states/daily.csv -o ./data/us_states_covid19_daily.csv
if [ $? -ne 0 ]; then
...
curl https://covidtracking.com/api/v1/states/ca/daily.csv -o ./data/ca_counties_covid19_daily.csv
if [ $? -ne 0 ]; then
